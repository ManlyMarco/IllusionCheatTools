...
namespace CheatTools
{
    ...
    public class CheatTools : BaseUnityPlugin
    {
        ...
        protected void OnGUI()
        {
            ...
            if (_inspector._alignedButtonStyle == null)
                _inspector._alignedButtonStyle = new GUIStyle(GUI.skin.button)
                {
            ...
            var e = Event.current;
            if (e.keyCode == KeyCode.Return) _inspector._userHasHitReturn = true;
